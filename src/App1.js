    ...
    <div className="app">
      ...
      <div className="sidebar">
        <div className="profile-frame">
          <img src="/profile.jpg" alt="Satprem Rath" />
        </div>
      <h2 className="sidebar-name">Satprem Rath</h2>
      <p className="sidebar-title"> 
        GenAI Engineer | Data Scientist | Blogger
      </p>
      </div>
      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          ...
          <h1>
            Hi, I’m <span className="highlight">Satprem</span>.
          </h1>
